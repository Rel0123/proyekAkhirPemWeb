                        ...
                        <div class="paralax">
                          ...
                          <div class="row mx-3">
                                ...
                                <tr>
                                  ...
                                  <td style="width:875px ;"><input id="name" class="form-control mt-3" type="text" name="name" value="{{$calon->name}}" required autofocus ></td>
                                  

                                </tr>
                                <tr>
                                  <td> <x-label for="nik" :value="__('NIK')" /> </td>
                                  <td><input readonly class="form-control mt-3" id="nik" type="text" name="nik" value="{{$calon->nik}}" required autofocus ></td>
                                ...
                                <tr>
                                  ...
                                  <td>
                                          ...
                                          <input class="form-control mt-3" id="address" type="text" name="address" value="{{$calon->address}}" required autofocus>
                                          
                                  </td>
                                </tr>
                                <tr>
                                  <td> <x-label for="status" :value="__('Status')" /> </td>
                                  <td><input class="form-control mt-3" id="status" type="text" name="status" value="{{$calon->status}}" required autofocus></td>
                                </tr>
                                <tr>
                                  <td><x-label for="description" :value="__('Deskripsi')" /></td>
                                  <td><input class="form-control mt-3" id="description" type="text" name="description" value="{{$calon->description}}" required autofocus></td>
                                </tr>
